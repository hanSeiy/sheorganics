"""
Django settings for SHEorganics project.
...
SECRET_KEY = 'django-insecure-_)q+!^9y#p50*w&m9$-6!tfrh7vdx$h(hhe=%i6=m(+9_1e868'
...
WSGI_APPLICATION = 'SHEorganics.wsgi.application'
